...
Any non-zero probe exit fails the job. The bbox math probe is the shared guard
for `godot-android/fixtures/bbox_math_test_vectors.json`; changing an expected
