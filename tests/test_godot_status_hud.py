...
class GodotStatusHudTests(unittest.TestCase):
    def test_status_hud_renders_label_and_writes_status_files(self):
        ...
        self.assertIn("const STATUS_LABEL_UPDATE_INTERVAL_SECONDS := 0.25", source)
        ...
        self.assertIn("if not force and _status_label_update_elapsed < STATUS_LABEL_UPDATE_INTERVAL_SECONDS:", source)
        self.assertIn("if next_text != _status_label.text:", source)
        ...
        self.assertIn("func _format_vec3(value) -> String:", source)
    ...
    def test_moving_card_feeds_status_hud_with_a_per_frame_snapshot(self):
        ...
        self.assertIn("_status_hud.update_status_label(_build_status_snapshot(), 0.0, true)", card)
        ...
        self.assertIn("_status_hud.update_status_label(snapshot, delta)", card)
