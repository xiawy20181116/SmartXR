...
class GodotSmartXROptionsTests(unittest.TestCase):
    ...
    def test_options_cover_control_and_proxy_targets_ws_settings(self):
        ...
        self.assertIn('const ENV_PROXY_TARGETS_POSE_TRACE_PATH := "SMARTXR_PROXY_TARGETS_POSE_TRACE_PATH"', source)
        self.assertIn('const ENV_XR_POSE_TRACE_PATH := "SMARTXR_XR_POSE_TRACE_PATH"', source)
        ...
        self.assertIn('const ENV_PROXY_TARGETS_CARD_REACQUIRE_ENABLED := "SMARTXR_PROXY_TARGETS_CARD_REACQUIRE_ENABLED"', source)
        self.assertIn('const ENV_PROXY_TARGETS_CARD_REACQUIRE_SMOOTHING_MS := "SMARTXR_PROXY_TARGETS_CARD_REACQUIRE_SMOOTHING_MS"', source)
        self.assertIn('const ENV_PROXY_TARGETS_CARD_REACQUIRE_MAX_STEP_M := "SMARTXR_PROXY_TARGETS_CARD_REACQUIRE_MAX_STEP_M"', source)
        self.assertIn('const ENV_PROXY_TARGETS_CARD_REACQUIRE_SETTLE_EPSILON_M := "SMARTXR_PROXY_TARGETS_CARD_REACQUIRE_SETTLE_EPSILON_M"', source)
        ...
        self.assertIn("func proxy_targets_pose_trace_path(default_path: String) -> String:", source)
        self.assertIn('return resolve_string("proxy_targets_pose_trace_path", ENV_PROXY_TARGETS_POSE_TRACE_PATH, default_path)', source)
        self.assertIn("func xr_pose_trace_path(default_path: String) -> String:", source)
        self.assertIn('return resolve_string("xr_pose_trace_path", ENV_XR_POSE_TRACE_PATH, default_path)', source)
        ...
        self.assertIn("func proxy_targets_card_reacquire_rule(default_rule: Dictionary) -> Dictionary:", source)
        self.assertIn('proxy_targets_card_reacquire_rule', source)
        self.assertIn('resolve_bool("proxy_targets_card_reacquire_enabled"', source)
        self.assertIn('resolve_float("proxy_targets_card_reacquire_smoothing_ms"', source)
        self.assertIn('resolve_float("proxy_targets_card_reacquire_max_step_m"', source)
        self.assertIn('resolve_float("proxy_targets_card_reacquire_settle_epsilon_m"', source)
    ...
    def test_moving_card_routes_ws_config_through_options(self):
        ...
        self.assertIn('const PROXY_TARGETS_CARD_REACQUIRE_RULE := {', source)
        self.assertIn("_options.proxy_targets_card_reacquire_rule(PROXY_TARGETS_CARD_REACQUIRE_RULE)", source)
        self.assertIn("_card_attachment.set_reacquire_rule(_options.proxy_targets_card_reacquire_rule(PROXY_TARGETS_CARD_REACQUIRE_RULE))", source)
    ...
    def test_options_are_documented(self):
        ...
        self.assertIn("SMARTXR_PROXY_TARGETS_POSE_TRACE_PATH", doc)
        self.assertIn("proxy_targets_pose_trace_path", doc)
        self.assertIn("godot_pose_trace.jsonl", doc)
        ...
        self.assertIn("proxy_targets_card_reacquire_rule", doc)
        self.assertIn("SMARTXR_PROXY_TARGETS_CARD_REACQUIRE_SMOOTHING_MS", doc)
        self.assertIn("dynamic_held_to_dynamic", doc)
        self.assertIn("card_reacquire_state", doc)
    ...
    def test_repo_level_smartxr_options_config_is_editable(self):
        ...
        self.assertEqual(config["proxy_targets_pose_trace_path"], "")
        self.assertEqual(config["xr_pose_trace_path"], "")
        ...
        reacquire_rule = config["proxy_targets_card_reacquire_rule"]
        self.assertEqual(reacquire_rule["enabled"], True)
        self.assertEqual(reacquire_rule["trigger"], "dynamic_held_to_dynamic")
        self.assertEqual(reacquire_rule["smoothing_ms"], 250)
        self.assertEqual(reacquire_rule["max_step_m"], 0.2)
        self.assertEqual(reacquire_rule["settle_epsilon_m"], 0.03)
    ...
    def test_runtime_probe_and_runner_exist(self):
        ...
        self.assertIn("env_pose_trace_path", probe)
        self.assertIn("config_pose_trace_path", probe)
        self.assertIn("config_card_offset_rule", probe)
        self.assertIn("env_card_offset_rule", probe)
        self.assertIn("default_card_reacquire_rule", probe)
        self.assertIn("config_card_reacquire_rule", probe)
        self.assertIn("env_card_reacquire_rule", probe)
